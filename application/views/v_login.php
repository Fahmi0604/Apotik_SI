	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
                ...
                {
                    echo '<div id="pesan" class="alert alert-danger" role="alert">'.$this->session->flashdata('failed').'</div>';
                    //echo validation_errors('<div class="alert alert-danger" role="alert">'.$this->session->flashdata('failed').'</div>');
                }	
                ?>
